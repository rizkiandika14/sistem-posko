                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3>Data Pelaporan Banjir Dibatalkan</h3>
                        </div>
                        <div class="card-header p-2">
                            <ul class="nav nav-pills ml-3">
                                <li class="nav-item"><a class="nav-link" href="/manage_pelaporan">Semua Data</a></li>
                                <li class="nav-item"><a class="nav-link active" href="/manage_pelaporan/batal">Dibatalkan</a></li>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active">
                                    <form action="/manage_pelaporan/filter_batal" method="POST">
