                    ...
                    <div class="card">
                        ...
                        <div class="card-header p-2">
                            <ul class="nav nav-pills ml-3">
                                <li class="nav-item"><a class="nav-link active" href="/manage_pelaporan">Semua Data</a></li>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active">
                                    <form action="/manage_pelaporan/filter" method="POST">
                                    ...
                                    <?php foreach ($laporans as $laporan) : ?>
                                        <tr>
                                            ...
                                            <th><a class="btn btn-primary btn-sm" href="/pelaporan/detail/<?= $laporan['id_pelaporan']; ?>">
                                                ...
                                                <?php if ($laporan['status'] == 'proses') : ?>
                                                    <button type="button" data-toggle="modal" data-target="#modal-konfirmasi<?= $laporan['id_pelaporan']; ?>" class="btn btn-info btn-sm">
