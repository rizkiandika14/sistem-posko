                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($kecamatans as $kecamatan) : ?>
                                        <tr>
                                            <th><?= $no++; ?></th>
                                            <th><?= $kecamatan->nama_kabupaten; ?></th>
                                            <th><?= $kecamatan->nama_kecamatan; ?></th>
                                            <th><?= $kecamatan->jumlah_desa; ?></th>
                                            <th><button type="button" data-toggle="modal" data-target="#modal-edit<?= $kecamatan->id; ?>" class="btn btn-info btn-sm">
...
<?php foreach ($kecamatans as $kecamatan) : ?>
    <div class="modal fade" id="modal-edit<?= $kecamatan->id; ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="/kecamatan/update/<?= $kecamatan->id; ?>" method="post">
                    <?= csrf_field(); ?>
                    <input type="hidden" class="form-control" name="id" value="<?= $kecamatan->id; ?>" required>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="search-kabupaten" name="id_kabupaten" style="width: 100%;" required>
                                <option value=""></option>
                                <?php foreach ($kabupatens as $value) : ?>
                                    <option value="<?= $value['id']; ?>" <?= $kecamatan->id_kabupaten == $value['id'] ? 'selected' : ''; ?>><?= $value['nama_kabupaten']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group">
