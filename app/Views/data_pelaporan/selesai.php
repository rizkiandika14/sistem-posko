                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h2>Data Selesai Pelaporan Banjir</h2>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="/data_pelaporan/filter_selesai" method="POST">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($laporans as $laporan) : ?>
                                        <tr>
                                            ...
                                            <th><span class="badge badge-success text-bold" style="font-size: 15px;"><?= $laporan['status']; ?></span></th>
