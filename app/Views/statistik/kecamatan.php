                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3>Data Statistik Kebutuhan</h3>
                        </div>
                        <div class="card-header p-2">
                            <ul class="nav nav-pills ml-3">
                                <li class="nav-item"><a class="nav-link" href="/statistik">Kabupaten</a></li>
                                <li class="nav-item"><a class="nav-link active" href="/statistik/kecamatan">Kecamatan</a></li>
                                <li class="nav-item"><a class="nav-link" href="/statistik/desa">Desa</a></li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active">
                                    <form action="/statistik/filter_kecamatan" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="search-kecamatan1" name="id_kecamatan" style="width: 100%;" required>
                                                <option value=""></option>
                                                <option value="semua">Semua Kecamatan di kabupaten yg dipilih</option>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-5 ml-2 mr-2">
                                        <div class="form-group">
                                            <label>Jumlah Kabupaten terkena banjir <badge type="button" style="color: blue;" class="badge" data-toggle="modal" data-target="#modal-kabupaten">lihat</badge></label>
                                            <input type="text" class="form-control form-control-border border-width-2" id="kabupaten" name="kabupaten" value="<?= $laporan['total_kabupaten']; ?> kabupaten" readonly>
                                        </div>
                                        <div class="form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Jumlah Kabupaten terkena banjir</h5>
            ...
            <div class="modal-body">
                <div class="card">
                    <?php foreach ($kabs as $laporan) : ?>
                        <div class="card-header">
                            <h3 class="card-title">Jumlah Kabupaten : <?= $laporan['total_kabupaten']; ?> kabupaten</h3>
                        </div>
                    <?php endforeach; ?>
                    <div class="card-body">
                        <div class="chartjs-size-monitor">
                        ...
                        <canvas id="total_kab" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 568px;" width="568" height="250" class="chartjs-render-monitor"></canvas>
                    </div>
                </div>
            </div>
...
<script>
    // JUMLAH KABUPATEN
    var jml_kabupaten = $('#total_kab').get(0).getContext('2d');
    var data_jml_kabupaten = [];
    var label_jml_kabupaten = [];

    <?php foreach ($stats as $key => $value) : ?>
        data_jml_kabupaten.push(<?= $value->total_kabupaten; ?>);
        label_jml_kabupaten.push('<?= $value->nama_kabupaten; ?>');
    <?php endforeach; ?>
