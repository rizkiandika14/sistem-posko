                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-5 mr-2">
                                    <div class="card-header">
                                        <h3 class="card-title">Statistik Total yang terkena banjir Di kecamatan Per Kabupaten</h3>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="col-md-5">
                                    <div class="card-header">
                                        <h3 class="card-title">Statistik Total Kebutuhan Di kecamatan Per Kabupaten</h3>
                                    </div>
                                    <div class="card-body">
                                        <div class="chartjs-size-monitor">
                                            <div class="chartjs-size-monitor-expand">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-5 ml-2 mr-2">
                                        ...
                                        <div class="form-group">
                                            <label>Jumlah Desa terkena banjir</label>
